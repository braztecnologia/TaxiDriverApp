package driver.lsit.texi.constant;

/**
 * Created by Vikram on 08/10/18.
 */
public class Url {
    ...
    public static String imageurl="http://138.68.5.43/driverimages/";
    public static String userImageUrl = "http://138.68.5.43/user_image/";
    public static String subscribeUrl = "http://162.243.225.225:8002/subscribe";
    public static String unsubscribeUrl = "http://162.243.225.225:8002/unsubscribe";
